    ...
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">
                ...
                if($jab==2){
                    ?>
                    <button class="btn btn-info" data-toggle="modal" data-target="#laporan_surat_keluar_id">
                    <i class="fa fa-calendar"></i> Laporan Surat Keluar
                </button>
                    <?php
                }else{ 
                ?>
            ...
            <div class="panel-body">
                ...
                ?>
                    ...
                    if (isset($data_surat_keluar)) {
                        foreach ($data_surat_keluar as $surat_keluar) {
                            ?>
                            <tr>
                                <td class="text-center" style="vertical-align: middle;"><?php echo $surat_keluar->nomor_surat ?></td>
                                <td class="text-center" style="vertical-align: middle;"><?php echo $surat_keluar->tgl_kirim ?></td>
                                <td class="text-center" style="vertical-align: middle;"><?php echo $surat_keluar->tujuan ?></td>
                                <td class="text-center" style="vertical-align: middle;"><?php echo $surat_keluar->perihal ?></td>
                                <td class="text-center" style="vertical-align: middle;"><a href="<?php echo base_url('uploads/' . $surat_keluar->file_surat) ?>"><i class="fa fa-envelope"></i></a></td>
                                <?php 
                $jab = $this->session->userdata('id_jabatan');
                if($jab==2){
                }else{ 
                ?>
                                <td class="text-center" style="vertical-align: middle;">
                                    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#ubah_surat_keluar" onclick="ubah_surat(<?php echo $surat_keluar->id_surat ?>)">Ubah</button>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ubah_file_surat_keluar" onclick="ubah_surat(<?php echo $surat_keluar->id_surat ?>)">Ubah Surat</button>
                                    <a href="<?php echo base_url('home/hapus_surat_keluar/' . $surat_keluar->id_surat) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                </td>
                                <?php } ?>
                            </tr>
                            <?php
...
<div class="modal fade" id="laporan_surat_keluar_id" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form target="__blank" action="<?php echo base_url('home/laporan_surat_keluar_id') ?>" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title text-center" id="myModalLabel">Laporan Surat Keluar</h4>
                </div>
