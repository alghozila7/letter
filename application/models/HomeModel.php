...
class HomeModel extends CI_Model {
    ...
    public function non_pengguna($where,$data,$table){
        $this->db->where($where);
        $this->db->update($table,$data);
    }

    public function aktif_pengguna($where,$data,$table){
        $this->db->where($where);
        $this->db->update($table,$data);
    }
    ...
    public function get_pengguna() {
        return $this->db->join('jabatan', 'pegawai.id_jabatan = jabatan.id_jabatan')
        ->where('jabatan.id_jabatan', 1)
        ->or_where('jabatan.id_jabatan', 3)
            ->get('pegawai')->result();
    }
    ...
    function update_mark($where,$data,$table){
        $this->db->where($where);
        $this->db->update($table,$data);
    }
